...
/**
 * This is the model class for table "{{carrera_asignacion}}".
 *
 * The followings are the available columns in table '{{carrera_asignacion}}':
 * @property integer $id
 * @property integer $id_carrera
 * @property integer $id_vehiculo
 * @property string $time
 */
class CarreraAsignacion extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CarreraAsignacion the static model class
	 */
