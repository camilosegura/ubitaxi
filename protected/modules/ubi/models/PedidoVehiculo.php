...
/**
 * This is the model class for table "{{pedido_vehiculo}}".
 *
 * The followings are the available columns in table '{{pedido_vehiculo}}':
 * @property integer $id
 ...
 */
class PedidoVehiculo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PedidoVehiculo the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, id_pedido, id_vehiculo, time, valor, unidades, direccion_destino, latitud, longitud', 'safe', 'on'=>'search'),
		);
	}
